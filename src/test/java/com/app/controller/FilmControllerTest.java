...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = WebSecurityTestConfig.class)
...
class FilmControllerTest {
    ...
    void initFilms() {
        this.films.addAll(
                List.of(new Film("film1", LocalDate.of(2022, 6, 2)), new Film("film2", LocalDate.of(2022, 6, 2)),
    ...
    void testFindAll() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/films/all")).andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testSearch() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/films/find").param("tittle", "film"))
                .andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("films"))
                .andExpect(MockMvcResultMatchers.model().attribute("films", Matchers.hasSize(3)));
