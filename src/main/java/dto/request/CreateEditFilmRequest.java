...
public class CreateEditFilmRequest extends Request {
    ...
    public CreateEditFilmRequest(String filmId, String filmName, Date filmDate, LinkedList<String> filmGenres,
