    ...
    <form action="../${eventType}" method="post">
        <div class="row">
            <div class="col-6">
                ...
                <input class="form-control" name="name" value="${director.getName()}">
            </div>
            <div class="col-6">
                <span>Age</span>
                <input class="form-control" name="year" value="${director.getYear()}">
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                <div class="films">
                    ...
                    <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton1">
                        <select class="form-select" multiple aria-label="multiple select example" name="films">
                            <c:forEach var="film" items="${directorFilmList}">
