                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-end">
                        <div class="text-end">
                            <sec:authorize access="!isAuthenticated()">
                                <button onclick="window.location.href = '/login'" type="button" class="btn btn-light text-dark me-2">Log
                                    in
                                </button>
                                <button onclick="window.location.href = '/registration'" type="button" class="btn btn-primary">Sign-up
                                </button>
                            </sec:authorize>
                            <sec:authorize access="isAuthenticated()">
                                <button onclick="window.location.href = '/logout'" type="button" class="btn btn-light text-dark-me-2">Log
                                    out
                                </button>
                                <sec:authorize access="hasRole('ADMIN')">
                                    <button onclick="window.location.href = '/admin'" type="button" class="btn btn-light text-dark-me-2">
                                        Users
                                    </button>
                                </sec:authorize>
                            </sec:authorize>
